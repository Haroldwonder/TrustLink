...
- [x] 1. Update Makefile `optimize` target with wasm-opt and size reporting
...
- [x] 2. Implement size-reporting helper function in Rust (for property testing)
  ...
  - [x]* 2.1 Write property test for size reduction reporting accuracy
...
- [x] 4. Write property test: source files unchanged after optimization
  ...
  - [x]* 4.1 Write property test for deterministic optimization output
...
- [x] 5. Update README.md with optimization documentation
  ...
  - [x]* 5.1 Write example test: README contains required content
