...
* **#927:** add cargo check --workspace as required CI gate ([4e9c6d9](https://github.com/Haroldwonder/TrustLink/commit/4e9c6d965ab744ccf8f6ba6eef6f531b80ac29cf)), closes [#927](https://github.com/Haroldwonder/TrustLink/issues/927)
...
* add carbon-credit verifier-of-verifiers example ([#1018](https://github.com/Haroldwonder/TrustLink/issues/1018)) ([156cfe6](https://github.com/Haroldwonder/TrustLink/commit/156cfe6f2504579709444d7da2cd2a78cb9c0090))
...
* add DID-style guardian social-recovery example ([#1019](https://github.com/Haroldwonder/TrustLink/issues/1019)) ([452e6a6](https://github.com/Haroldwonder/TrustLink/commit/452e6a6f73de744e853aa2978793f0ffcb4abef4))
* add event ticketing example ([8701199](https://github.com/Haroldwonder/TrustLink/commit/8701199570cac2840567caad5616c45bfbc858c0))
...
* add get_expiring_attestations for subjects and issuers ([#604](https://github.com/Haroldwonder/TrustLink/issues/604)) ([b34bb39](https://github.com/Haroldwonder/TrustLink/commit/b34bb39b3c04b106724b469428e7b653e65d30cd))
...
* add missing error variants ([#919](https://github.com/Haroldwonder/TrustLink/issues/919)) ([c22ddd9](https://github.com/Haroldwonder/TrustLink/commit/c22ddd9717d2e195facd2ffa5bd2a2c114dce45b))
* add NFT marketplace example gated by KYC and jurisdiction ([9be831a](https://github.com/Haroldwonder/TrustLink/commit/9be831a3bb71a8a4bcbcca621a754bf3a4116022)), closes [#1024](https://github.com/Haroldwonder/TrustLink/issues/1024)
* add optional per-subject attestation limit to prevent unbounded growth ([f5b662e](https://github.com/Haroldwonder/TrustLink/commit/f5b662e6fd0a9b12c290cbcab4ebed4b681ad357))
...
* add trade finance example ([b431b41](https://github.com/Haroldwonder/TrustLink/commit/b431b412e95cfb49d29bed9e935d28599b7d8ed0))
...
* add version compatibility guard for state-changing entry points ([7176ede](https://github.com/Haroldwonder/TrustLink/commit/7176ede5cc5063f6c300e6aec5a1e26b6624828b)), closes [#952](https://github.com/Haroldwonder/TrustLink/issues/952)
...
* add WASM binary hash as first-class release artifact ([9921b39](https://github.com/Haroldwonder/TrustLink/commit/9921b394bba5bfcb34a612ec93e66bb8a0890885))
...
* **bindings:** add Rust RPC client crate with core read queries ([9005faf](https://github.com/Haroldwonder/TrustLink/commit/9005faf0bac4ec05a60414da259e7b7f33f13bdf))
...
* **errors:** single source of truth for contract error codes ([#964](https://github.com/Haroldwonder/TrustLink/issues/964)) ([a7c33f6](https://github.com/Haroldwonder/TrustLink/commit/a7c33f64388a50c5aa2d5e45dbc1055e49f0d715))
* **examples:** add IssuerTier-gated lending-pool reference ([b042191](https://github.com/Haroldwonder/TrustLink/commit/b0421919e7cf716387db793d8bf957d96802f276)), closes [#1022](https://github.com/Haroldwonder/TrustLink/issues/1022)
* **examples:** add multi-tenant SaaS seat-license verification ([07ead56](https://github.com/Haroldwonder/TrustLink/commit/07ead56aaa5496dad65aee72b28b52e5e9ca67d6))
...
* expose list_endorsements_by_endorser in public contract interface (issue [#939](https://github.com/Haroldwonder/TrustLink/issues/939)) ([a4e58eb](https://github.com/Haroldwonder/TrustLink/commit/a4e58eb5968cead3bb6e04aa858c90a676cd0b58))
...
* implement atomic attestation bundling with shared bundle IDs ([268925a](https://github.com/Haroldwonder/TrustLink/commit/268925addcd08d3410a117105596bbe31afc099a))
...
* implement unified event-topic taxonomy and SDK filtering ([2864d64](https://github.com/Haroldwonder/TrustLink/commit/2864d64fd329f0434c2b0e277d113909c43c382a))
...
* **indexer:** bulk export, log sampling, route fix, and cross-SDK conformance ([10b0a5e](https://github.com/Haroldwonder/TrustLink/commit/10b0a5e7cbe380bcf0852153e3fb8e8400f30820))
...
* **indexer:** replace in-memory PubSub with Redis-backed implementation for horizontal scaling ([ac65608](https://github.com/Haroldwonder/TrustLink/commit/ac656081aa6f7fd73a5553cb5ccea22c02ff6bb2))
* **indexer:** support multiple contract IDs with per-contract data partitioning ([fb9d7b6](https://github.com/Haroldwonder/TrustLink/commit/fb9d7b6054b52cf9c190bf15da8e24139f3af5bb))
...
* **react:** implement and export useGlobalStats hook ([#962](https://github.com/Haroldwonder/TrustLink/issues/962)) ([7ebfad5](https://github.com/Haroldwonder/TrustLink/commit/7ebfad5437f6674f4ef6ef94a1ee41ed4656db0d))
...
* **sdk:** add W3C Verifiable Credential export for attestations ([7a066ef](https://github.com/Haroldwonder/TrustLink/commit/7a066ef90b6a9823087966625c08f6bee626b751))
...
* **storage,admin:** make ChunkedIndex chunk size admin-configurable ([1467efe](https://github.com/Haroldwonder/TrustLink/commit/1467efec589d3e235c13ceda4a5d6708b9fb0f01)), closes [#956](https://github.com/Haroldwonder/TrustLink/issues/956)
...
* **#928:** fix duplicate Prometheus metric names and add registration test ([3b77350](https://github.com/Haroldwonder/TrustLink/commit/3b77350b78679791ff184f867de6c143642f20ef)), closes [#928](https://github.com/Haroldwonder/TrustLink/issues/928)
* **#929:** fix ms_sign event handler undefined variable and add end-to-end test ([90dab0a](https://github.com/Haroldwonder/TrustLink/commit/90dab0a4221ffd5eaa84e3b47f040775c43502f1)), closes [#929](https://github.com/Haroldwonder/TrustLink/issues/929)
* 910: Fix build - resolve duplicate methods and add missing error variants ([b570847](https://github.com/Haroldwonder/TrustLink/commit/b57084762b571721a642eb8bd67c3ed55df482fb))
* 911: Remove duplicate StorageKey enum variants ([c05a39e](https://github.com/Haroldwonder/TrustLink/commit/c05a39e2ed565e3988d8370b9a5f7b230083e2b1))
* 912: Remove duplicate struct definitions in types.rs ([9d204af](https://github.com/Haroldwonder/TrustLink/commit/9d204af23239e799421ba141a71ae43358c88530))
* 913: Ensure MultiSigProposal has cancelled field ([4f9b7a9](https://github.com/Haroldwonder/TrustLink/commit/4f9b7a9739da784870be9e402396dff59ebdbf3f))
* add API key authorization to admin REST endpoints ([5ac1edb](https://github.com/Haroldwonder/TrustLink/commit/5ac1edbfac29d9b6610f5c6c7bace87d29147507)), closes [#935](https://github.com/Haroldwonder/TrustLink/issues/935)
* add cleanup mechanism for expired attestation requests (issue [#940](https://github.com/Haroldwonder/TrustLink/issues/940)) ([8a255d1](https://github.com/Haroldwonder/TrustLink/commit/8a255d1db1b3d63f09cca78b57b8dfa7c9bc8d6e))
* add client-side input validation before constructing ScVals ([df8470b](https://github.com/Haroldwonder/TrustLink/commit/df8470b5b6f826c4586baec16a0edfe94ca237e5))
...
* enforce require_not_paused in cancel_multisig_proposal ([3e40e2a](https://github.com/Haroldwonder/TrustLink/commit/3e40e2aa7350a9d78bafe61af3727948e965e433)), closes [#950](https://github.com/Haroldwonder/TrustLink/issues/950)
...
* **indexer:** consistent subscription filters, dead-letter, federation ADR, scaling docs ([#974](https://github.com/Haroldwonder/TrustLink/issues/974)-[#977](https://github.com/Haroldwonder/TrustLink/issues/977)) ([638e878](https://github.com/Haroldwonder/TrustLink/commit/638e878f61ac96b1666859f88ea2fe1a105f7915))
...
* **indexer:** resolve [#974](https://github.com/Haroldwonder/TrustLink/issues/974) [#975](https://github.com/Haroldwonder/TrustLink/issues/975) [#976](https://github.com/Haroldwonder/TrustLink/issues/976) [#977](https://github.com/Haroldwonder/TrustLink/issues/977) — subscription filters, backpressure, federation, scaling ([71f01f8](https://github.com/Haroldwonder/TrustLink/commit/71f01f87b101ac761b0012020b0b89223c2262ad))
* **indexer:** uniform subject/issuer/claimType filters on GraphQL subscriptions ([b86bb2d](https://github.com/Haroldwonder/TrustLink/commit/b86bb2dee59817168b8d31348f1a476662debaab))
...
* prevent duplicate pending requests across timestamps (issue [#941](https://github.com/Haroldwonder/TrustLink/issues/941)) ([ed587dc](https://github.com/Haroldwonder/TrustLink/commit/ed587dc7fffb073edc2f1deb667b2e35527261c3))
...
* remove duplicate event functions ([#915](https://github.com/Haroldwonder/TrustLink/issues/915)) ([3f692bf](https://github.com/Haroldwonder/TrustLink/commit/3f692bfb1927e131427eb0541db2127ab96ab5b3))
* remove duplicate get_multisig_ttl function ([#916](https://github.com/Haroldwonder/TrustLink/issues/916)) ([ba5d338](https://github.com/Haroldwonder/TrustLink/commit/ba5d3388a615bab5df304d796be1087365849cf9))
* remove duplicate storage methods ([#914](https://github.com/Haroldwonder/TrustLink/issues/914)) ([e5db61f](https://github.com/Haroldwonder/TrustLink/commit/e5db61f37836a2092d052775072793f8338211e1))
* remove hardcoded API key from TypeScript SDK ([cefedcb](https://github.com/Haroldwonder/TrustLink/commit/cefedcbbb960ec138edc7bdf9a2a23abf526f877)), closes [#934](https://github.com/Haroldwonder/TrustLink/issues/934)
...
* remove orphaned/duplicated code left by prior botched merges ([06df2a5](https://github.com/Haroldwonder/TrustLink/commit/06df2a56d6c56489e2161079066309b02d93f9a1))
* remove stray code fragment in lib.rs ([#917](https://github.com/Haroldwonder/TrustLink/issues/917)) ([2b563e7](https://github.com/Haroldwonder/TrustLink/commit/2b563e72367e9c9655f91b8ae0c0350ecc935020))
...
* repair build after merging 41 PRs (missing imports, storage fns, types) ([d1fe52e](https://github.com/Haroldwonder/TrustLink/commit/d1fe52e048526ebff0916f627579c12161178e64))
* replace bubble sort with insertion sort in expiring attestations queries ([d3190ee](https://github.com/Haroldwonder/TrustLink/commit/d3190ee4af75d2f31ef6f67ef8512e25e1b58aff)), closes [#937](https://github.com/Haroldwonder/TrustLink/issues/937)
...
* resolve issues [#958](https://github.com/Haroldwonder/TrustLink/issues/958) [#959](https://github.com/Haroldwonder/TrustLink/issues/959) [#960](https://github.com/Haroldwonder/TrustLink/issues/960) [#961](https://github.com/Haroldwonder/TrustLink/issues/961) ([675ce9d](https://github.com/Haroldwonder/TrustLink/commit/675ce9d4a55ce297658a5741df84061e564684ba))
...
* **types,storage,query,validation:** resolve duplicate definitions, missing StorageKey variants, and unwrap violations ([209519a](https://github.com/Haroldwonder/TrustLink/commit/209519a9f939f8e446ea01d8181b7e18e89303d5))
* validate TrustLinkClientOptions network option ([c68265c](https://github.com/Haroldwonder/TrustLink/commit/c68265c326c9d7b11fec81ef30ef7b96f6671aed))
* wire Prometheus metrics into event processing pipeline ([5a75e6a](https://github.com/Haroldwonder/TrustLink/commit/5a75e6ab7808cc56a9367743226dbd88f91dbe06)), closes [#936](https://github.com/Haroldwonder/TrustLink/issues/936)
