...
- **Status**: Accepted
- **Date**: 2024-04-23
- **Related Issues**: [#280](https://github.com/Idaonoli/TrustLink/issues/280)
...
- **Issue #280**: [Security: Prevent admin from setting themselves as fee_collector](https://github.com/Idaonoli/TrustLink/issues/280)
